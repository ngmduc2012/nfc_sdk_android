 ...
 *
 * $Id: SignedDataUtil.java 1835 2020-02-13 16:19:11Z martijno $
 */
...
public final class SignedDataUtil {
  ...
  public static List<X509Certificate> getCertificates(SignedData signedData) {
    ...
    for (int i = 0; i < certificateCount; i++) {
      try {
        Certificate certAsASN1Object = Certificate.getInstance(encodedCertificates.getObjectAt(i));
