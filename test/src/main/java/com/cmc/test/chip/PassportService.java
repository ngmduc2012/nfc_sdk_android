...
import com.cmc.test.chip.cert.CVCPrincipal;
import com.cmc.test.chip.cert.CardVerifiableCertificate;
import com.cmc.test.chip.protocol.AAAPDUSender;
import com.cmc.test.chip.protocol.AAProtocol;
import com.cmc.test.chip.protocol.AAResult;
import com.cmc.test.chip.protocol.BACAPDUSender;
import com.cmc.test.chip.protocol.BACProtocol;
import com.cmc.test.chip.protocol.BACResult;
import com.cmc.test.chip.protocol.EACCAAPDUSender;
import com.cmc.test.chip.protocol.EACCAProtocol;
import com.cmc.test.chip.protocol.EACCAResult;
import com.cmc.test.chip.protocol.EACTAAPDUSender;
import com.cmc.test.chip.protocol.EACTAProtocol;
import com.cmc.test.chip.protocol.EACTAResult;
import com.cmc.test.chip.protocol.PACEAPDUSender;
import com.cmc.test.chip.protocol.PACEProtocol;
import com.cmc.test.chip.protocol.PACEResult;
import com.cmc.test.chip.protocol.ReadBinaryAPDUSender;
import com.cmc.test.chip.protocol.SecureMessagingWrapper;
...
public class PassportService extends AbstractMRTDCardService {
  ...
  private static final Logger LOGGER = Logger.getLogger("com.cmc.test.chip");
