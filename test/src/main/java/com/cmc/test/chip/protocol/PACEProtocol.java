 ...
 *
 * $Id: PACEProtocol.java 1832 2019-12-03 15:31:46Z martijno $
 */
...
import com.cmc.test.chip.APDULevelPACECapable;
import com.cmc.test.chip.AccessKeySpec;
import com.cmc.test.chip.BACKeySpec;
import com.cmc.test.chip.PACEException;
import com.cmc.test.chip.PACEKeySpec;
import com.cmc.test.chip.PACESecretKeySpec;
import com.cmc.test.chip.PassportService;
import com.cmc.test.chip.Util;
import com.cmc.test.chip.lds.PACEInfo;
        ...
        try {
            ...
            try {
                ...
                if (mappingType == MappingType.CAM) {
                    ...
                    /* int encryptedChipAuthenticationDataLength = */
                    step4ResponseInputStream.readLength();
