 ...
 *
 * $Id: DefaultFileSystem.java 1824 2019-11-06 08:25:39Z martijno $
 */
...
import com.cmc.test.chip.io.FragmentBuffer;
import com.cmc.test.chip.io.FragmentBuffer.Fragment;
import com.cmc.test.chip.lds.CVCAFile;
import com.cmc.test.chip.lds.LDSFileUtil;
  ...
  public synchronized byte[] readBinary(int offset, int length) throws CardServiceException {
    ...
    try {
      ...
      if (fragment.getLength() > 0) {
         ...
         *
         * Bug reproduced using com.cmc.test.chip.AESSecureMessagingWrapper with AES-256.
         */
