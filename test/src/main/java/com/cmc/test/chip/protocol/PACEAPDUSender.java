 ...
 *
 * $Id: PACEAPDUSender.java 1819 2019-09-26 12:40:53Z martijno $
 */
...
import com.cmc.test.chip.AccessDeniedException;
...
public class PACEAPDUSender implements APDULevelPACECapable {
  ...
  private static final Logger LOGGER = Logger.getLogger("com.cmc.test.chip.protocol");
