...
import cist.cmc.nfc.sdk.core.chip.io.FragmentBuffer;
import cist.cmc.nfc.sdk.core.chip.io.FragmentBuffer.Fragment;
  ...
  public synchronized byte[] readBinary(int offset, int length) throws CardServiceException {
    ...
    try {
      ...
      if (fragment.getLength() > 0) {
         ...
         *
         * Bug reproduced using cist.cmc.nfc.sdk.core.chip.AESSecureMessagingWrapper with AES-256.
         */
